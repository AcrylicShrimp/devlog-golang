...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		...
		postattachment.Table:        postattachment.ValidColumn,
		...
		unsavedpostthumbnail.Table:  unsavedpostthumbnail.ValidColumn,
		unsavedpostvideo.Table:      unsavedpostvideo.ValidColumn,
	}
