    ...
    "paths": {
        ...
        "/admin/unsaved-posts/{uuid}/images/{image}": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "NoContent: when the image of the unsaved post has been deleted successfully"
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
        ...
        "/admin/unsaved-posts/{uuid}/thumbnail": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "NoContent: when the thumbnail of the unsaved post has been deleted successfully"
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
